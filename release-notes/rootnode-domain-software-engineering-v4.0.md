...
**Surface:** Chat-Project • **Tier:** Model-compatible (T1)

### Install

Download `rootnode-domain-software-engineering-cp.zip` below, then upload it in **Settings → Capabilities → Skills**. No unzipping required.
