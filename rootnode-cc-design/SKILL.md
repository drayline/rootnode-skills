...
- **Halt triggers, scope authorization and the ultracode default.** Every DESIGN MODE plan and every EVOLVE MODE update explicitly includes all three — ultracode stays off and is opted into per task, stated even when the plan proposes no topology. Non-negotiable.
