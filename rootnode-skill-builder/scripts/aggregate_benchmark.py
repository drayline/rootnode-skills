...
Schema alignment with agents/grader.md output is preserved verbatim per the
content-class policy in root_AGENT_ENVIRONMENT_ARCHITECTURE.md §4.10.

Usage:
    python aggregate_benchmark.py <benchmark_dir>

Example:
    python aggregate_benchmark.py benchmarks/2026-05-07T10-30-00/
